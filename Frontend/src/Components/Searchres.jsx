...
const Searchres = ({
  ...
  return (
    <div
      className={
        hidden +
        " capitalize absolute inset-y-0 mx-auto left-0 right-0 z-10 text-2xl px-4 md:px-4 lg:px-3 xl:px-2 rounded-xl mt-[4.2rem] md:mt-[5.2rem] items-center xl:w-1/4 lg:w-1/3 w-full md:w-1/2 h-24 transition-all duration-300"
      }
    >
